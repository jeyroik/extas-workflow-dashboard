<?php
namespace extas\components\plugins\workflows\jsonrpc\transitions\dispatchers\templates;
 ...
 * @package extas\components\plugins\workflows\jsonrpc\transitions\dispatchers\templates
...
class JsonRpcTransitionDispatcherTemplateUpdate extends Plugin
{
    ...
    public function __invoke(RequestInterface $request, ResponseInterface &$response, array &$jRpcData)
    {
        $update = new JsonRpcUpdate([
            JsonRpcUpdate::FIELD__ENTITY_NAME => 'transition dispatcher template',
