...
class JsonRpcErrors
{
    ...
    const ERROR__CAN_NOT_TRANSIT_ENTITY_TRANSITION = 10304;
    ...
    protected static $errorMap = [
        ...
        10304 => 'Can not transit entity by this transition, cause of incorrect state',
        10404 => 'Unknown',
